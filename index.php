		...
		<div class="wrap">
			<div class="main">
				...
				<section class="first_section block">
					...
					<a href="#1" class="scroll button-down">
						<svg width="22" height="29" viewBox="0 0 22 29" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M21.5002 17.944C21.5002 17.5382 21.3434 17.132 21.0351 16.8228L20.8996 16.6865C20.2829 16.0664 19.2844 16.0664 18.6693 16.6865L12.5761 22.8129L12.5761 2.08582C12.5761 1.21045 11.8695 0.5 10.9989 0.5C10.1283 0.5 9.42173 1.21045 9.42173 2.08582L9.42173 22.8129L3.32856 16.6865C2.71187 16.0664 1.71341 16.0664 1.0983 16.6865L0.962759 16.8228C0.346073 17.4428 0.346073 18.4467 0.962759 19.0652L9.8838 28.035C10.5005 28.655 11.4989 28.655 12.1141 28.035L21.0351 19.0652C21.3434 18.7552 21.5002 18.3497 21.5002 17.944Z" fill="white"/>
						</svg>
					</a>
				</section>
				...
				<section class="advantages block" id="1">
					<div class="cont">
						...
						<div class="block_head">
							<div class="title">Преимущества работы с нашей компанией</div>
					...
					<div class="cont">
						<form action="" class="form">
							<div class="block_head">
								...
								<div class="desc">Заполните анкету в форме заявки и наши менеджеры свяжутся с<br> вами в течение рабочего дня.</div>
							</div>						
							<div class="line">
								<div class="field">
						...
						<div class="slider owl-carousel">
							...
							<a href="/" class="service">
								<div class="inner">
									...
									<div class="info">
										<div class="name">Номер «Президентский Королевски Люкс»</div>
							...
							<a href="/" class="service">
								<div class="inner">
									<div class="img"><img data-src="images/tmp/service_thumb4.jpg" alt="" class="lozad"></div>
						...
						<div class="slider owl-carousel">
										...
										<div class="inner">
											<div class="review-quote">
												<svg width="38" height="31" viewBox="0 0 38 31" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path fill-rule="evenodd" clip-rule="evenodd" d="M38 8.5C38 3.80558 34.1944 0 29.5 0C27.1988 0.00297005 24.9971 0.938864 23.3981 2.5938C21.7991 4.24874 20.9395 6.48129 21.0156 8.78125C21.0051 8.85369 20.9999 8.9268 21 9C21 17.0726 23.6464 22.3497 26.3574 25.5352C29.0684 28.7206 31.9434 29.8926 31.9434 29.8926C32.444 30.107 33.0216 30.0331 33.4522 29.6997C33.8829 29.3663 34.099 28.8256 34.0168 28.2872C33.9347 27.7488 33.5671 27.2972 33.0566 27.1074C33.0566 27.1074 30.9316 26.2794 28.6426 23.5898C27.1222 21.8033 25.5777 19.2228 24.709 15.5195C26.1208 16.4836 27.7905 16.9995 29.5 17C34.1944 17 38 13.1944 38 8.5ZM17 8.5C17 3.80558 13.1944 0 8.5 0C6.19879 0.00297005 3.99711 0.938864 2.39812 2.5938C0.799129 4.24874 -0.0605202 6.48129 0.015625 8.78125C0.00508499 8.85369 -0.000137329 8.9268 0 9C0 17.0726 2.64643 22.3497 5.35742 25.5352C8.06841 28.7206 10.9434 29.8926 10.9434 29.8926C11.444 30.107 12.0216 30.0331 12.4522 29.6997C12.8829 29.3663 13.099 28.8256 13.0168 28.2872C12.9347 27.7488 12.5671 27.2972 12.0566 27.1074C12.0566 27.1074 9.93159 26.2794 7.64258 23.5898C6.12215 21.8033 4.57773 19.2228 3.70898 15.5195C5.12077 16.4836 6.79045 16.9995 8.5 17C13.1944 17 17 13.1944 17 8.5Z" fill="#D8A83A"/>
												</svg>	
											</div>
							...
							<div class="slide">
								<div class="review">									
									...
									<div class="review_bottom">
										<div class="review_bottom-photo">
											<img src="images/tmp/reviews-photo3.jpg" alt="">
										</div>
										<div class="review_bottom-author">
											<div class="review_bottom-name">Иван Петрович</div>
											<div class="review_bottom-post">ОАО «ГрупСтрой»</div>
				...
				<section class="team block">
					<div class="cont">
						...
						<div class="team_top">
							<div class="block_head">
								<div class="title">Наши<br> сотрудники</div>				
				...
				<section class="how_we_work block">
					<div class="cont">			
						...
						<div class="info">
							<div class="block_head">
								<div class="title">Схема нашей<br> работы</div>
							</div>	
							<div class="flex">
								<div class="item">
				...
				<section class="video_reviews block">
					<div class="cont">					
						...
						<div class="video_reviews_top">
							<div class="block_head">
								<div class="title">Наши видео<br>отзывы</div>				
								<div class="desc">Нам дорога наша репутация, поэтому мы дорожим каждым клиентом. Посмотрите, что они говорят и пишут о нас. Мы публикуем каждый оставленный отзыв о нашей компании.</div>
							</div>
							<div class="owl-nav-custom">
								<button type="button" role="presentation" class="prev"><svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.59577 6.35904L6.41677 10.18C6.83077 10.594 6.83077 11.266 6.41677 11.68C6.00277 12.094 5.33077 12.094 4.91677 11.68L0.302771 7.06604C-0.0882285 6.67504 -0.0882285 6.04204 0.302771 5.65204L4.91677 1.03804C5.33077 0.624039 6.00277 0.624039 6.41677 1.03804C6.83077 1.45204 6.83077 2.12404 6.41677 2.53804L2.59577 6.35904Z"></path></svg></button>
				...
				<section class="documents block">
					<div class="cont">
						<div class="documents_top">
							<div class="block_head">
								<div class="title">Наши<br> документы</div>				
								<div class="desc">Нам дорога наша репутация, поэтому мы дорожим каждым клиентом. Посмотрите, что они говорят и пишут о нас. Мы публикуем каждый оставленный отзыв о нашей компании.</div>
							</div>
							<div class="owl-nav-custom">
								<button type="button" role="presentation" class="prev"><svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.59577 6.35904L6.41677 10.18C6.83077 10.594 6.83077 11.266 6.41677 11.68C6.00277 12.094 5.33077 12.094 4.91677 11.68L0.302771 7.06604C-0.0882285 6.67504 -0.0882285 6.04204 0.302771 5.65204L4.91677 1.03804C5.33077 0.624039 6.00277 0.624039 6.41677 1.03804C6.83077 1.45204 6.83077 2.12404 6.41677 2.53804L2.59577 6.35904Z"></path></svg></button>
						...
						<div class="slider owl-carousel documents_wrap">
							<div class="slides">
								<a href="/" class="item">
									<div class="icon">
				...
				<section class="faq block">
					<div class="cont">
						<div class="block_head">
							...
							<div class="desc">Посмотрите наши основные товары и услуги и<br> убедитесь, что это именно то, что вы искали.</div>
						</div>
				...
				<section class="director_letter block">
					<div class="cont">
						...
						<div class="info">
							<div class="block_head">
								<div class="title">Письмо нашему директору</div>
							...
							<form action="" class="form">
								...
								<div class="bottom">
									<div class="agree">
										...
										<label for="agree_check">Согласен с политикой обработки данных</a>
				...
				<section class="stocks block">
					<div class="cont">
						<div class="stocks_top">
							<div class="block_head">
								<div class="title">Наши <br>Акции</div>					
								<div class="desc">Нам дорога наша репутация, поэтому мы дорожим каждым клиентом. Посмотрите, что они говорят и пишут о нас. Мы публикуем каждый оставленный отзыв о нашей компании.</div>
							</div>
							<div class="owl-nav-custom">
								<button type="button" role="presentation" class="prev"><svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.59577 6.35904L6.41677 10.18C6.83077 10.594 6.83077 11.266 6.41677 11.68C6.00277 12.094 5.33077 12.094 4.91677 11.68L0.302771 7.06604C-0.0882285 6.67504 -0.0882285 6.04204 0.302771 5.65204L4.91677 1.03804C5.33077 0.624039 6.00277 0.624039 6.41677 1.03804C6.83077 1.45204 6.83077 2.12404 6.41677 2.53804L2.59577 6.35904Z"></path></svg></button>
				...
				<section class="text_blocks block">
					<div class="cont">
						<div class="block_head">
							<div class="title">Текстовый блок</div>
						</div>
						<div class="text_block">
				...
				<section class="products block">
					<div class="cont">
						...
						<div class="block_head">
							<div class="title">Популярные Tовары</div>
							<div class="desc">Посмотрите наши основные товары и услуги и убедитесь, что это именно то, что вы искали.</div>		
						</div>
				...
				<section class="about_video block">
					<div class="cont">
						...
						<div class="info">
							<div class="block_head">
								<div class="title">Видео <br>о нашей<br> компании</div>
							</div>

							<div class="desc text_block">
								<p>
								Аутотренинг просветляет код. Кризис, несмотря на внешние воздействия, неустойчив. Конечно, нельзя не принять во внимание тот факт
								</p>
							</div>
							<a href="/" class="link">Позвонить Нам
								<svg width="13" height="8" viewBox="0 0 13 8" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M9.12247 0C8.97342 0 8.82421 0.0597364 8.71062 0.1772L8.66056 0.228835C8.43279 0.463763 8.43279 0.844131 8.66056 1.07846L10.911 3.39966H0.582515C0.260967 3.39966 0 3.66884 0 4.0005C0 4.33216 0.260967 4.60134 0.582515 4.60134H10.911L8.66056 6.92255C8.43279 7.15747 8.43279 7.53784 8.66056 7.77217L8.71062 7.8238C8.93838 8.05873 9.30715 8.05873 9.53433 7.8238L12.8292 4.42531C13.0569 4.19039 13.0569 3.81002 12.8292 3.57569L9.53433 0.1772C9.42045 0.0597364 9.27152 0 9.12247 0Z" fill="white"></path>
								</svg>
							</a>
						</div>
					</div>
						...
						<div class="flex">
							<div>
								<a href="images/tmp/gallery_thumb.jpg" class="item fanycy_img" data-fancybox="gallery">
									...
									<div class="info">
										<div class="desc">Юрист готовит договор</div>
									</div>
								</a>
							</div>
							<div>
								<a href="images/tmp/gallery_thumb2.jpg" class="item fanycy_img" data-fancybox="gallery">
									...
									<div class="info">
										<div class="desc">Наш менеджер Виктория работаеет для вас</div>
									</div>
								</a>
							</div>
							<div>
								<a href="images/tmp/gallery_thumb3.jpg" class="item fanycy_img" data-fancybox="gallery">
									...
									<div class="info">
										<div class="desc">Юрист готовит договор с партнером</div>
									</div>
								</a>
							</div>
							<div>
